			...
			<div class="container-fluid">
				...
				<div class="row mt-3"></div>
					<table class="table">
					    ...
					    <tbody>
					    	<c:choose>
					    		<c:when test="${qnaDto.qna_category == '[배송]' }">
						    	...
						    	<c:when test="${qnaDto.qna_category == '[주문/결제]' }">
							    	<c:forEach var="qnaDto" items="${pageList}">
								    	<tr onclick="location.href='${pageContext.request.contextPath}/controller/qna/qnaDetailController?qna_no=${qnaDto.qna_no}'" style="cursor:pointer;">
								    		<td>${qnaDto.qna_no}</td>
								    		<td>${qnaDto.qna_category}</td>
						    	...
						    	<c:when test="${qnaDto.qna_category == '[도서/상품정보]' }">
							    	<c:forEach var="qnaDto" items="${pageList}">
								    	<tr onclick="location.href='${pageContext.request.contextPath}/controller/qna/qnaDetailController?qna_no=${qnaDto.qna_no}'" style="cursor:pointer;">
								    		<td>${qnaDto.qna_no}</td>
								    		<td>${qnaDto.qna_category}</td>
						    	...
						    	<c:when test="${qnaDto.qna_category == '[반품/교환/환불]' }">
							    	<c:forEach var="qnaDto" items="${pageList}">
								    	<tr onclick="location.href='${pageContext.request.contextPath}/controller/qna/qnaDetailController?qna_no=${qnaDto.qna_no}'" style="cursor:pointer;">
								    		<td>${qnaDto.qna_no}</td>
								    		<td>${qnaDto.qna_category}</td>
						    	...
						    	<c:when test="${qnaDto.qna_category == '[회원정보서비스]' }">
							    	<c:forEach var="qnaDto" items="${pageList}">
								    	<tr onclick="location.href='${pageContext.request.contextPath}/controller/qna/qnaDetailController?qna_no=${qnaDto.qna_no}'" style="cursor:pointer;">
								    		<td>${qnaDto.qna_no}</td>
								    		<td>${qnaDto.qna_category}</td>
						    	...
						    	<c:when test="${qnaDto.qna_category == '[웹사이트 이용 관련]' }">
							    	<c:forEach var="qnaDto" items="${pageList}">
								    	<tr onclick="location.href='${pageContext.request.contextPath}/controller/qna/qnaDetailController?qna_no=${qnaDto.qna_no}'" style="cursor:pointer;">
								    		<td>${qnaDto.qna_no}</td>
								    		<td>${qnaDto.qna_category}</td>
						    	...
						    	<c:when test="${qnaDto.qna_category == '[시스템 불편사항]' }">
							    	<c:forEach var="qnaDto" items="${pageList}">
								    	<tr onclick="location.href='${pageContext.request.contextPath}/controller/qna/qnaDetailController?qna_no=${qnaDto.qna_no}'" style="cursor:pointer;">
								    		<td>${qnaDto.qna_no}</td>
								    		<td>${qnaDto.qna_category}</td>
						    	...
						    	<c:when test="${qnaDto.qna_category == '[기타]' }">
							    	<c:forEach var="qnaDto" items="${pageList}">
								    	<tr onclick="location.href='${pageContext.request.contextPath}/controller/qna/qnaDetailController?qna_no=${qnaDto.qna_no}'" style="cursor:pointer;">
								    		<td>${qnaDto.qna_no}</td>
								    		<td>${qnaDto.qna_category}</td>
				...
				<div class="row justify-content-center mt-3">
					<div>
						<a href="${pageContext.request.contextPath}/controller/qna/qnaBoardCategoryController?pageNo=1&category=${categoryNo}" class="btn btn-outline-primary btn-sm" style="background-color:#ffffff; color:black">처음</a>
						
						<c:if test="${pager.groupNo >1 }">
							<a href="${pageContext.request.contextPath}/controller/qna/qnaBoardCategoryController?pageNo=${pager.startPageNo-1}&category=${categoryNo}" class="btn btn-outline-info btn-sm" style="background-color:#ffffff; color:black">이전</a>
						</c:if>
						<c:forEach var="i" begin="${pager.startPageNo}" end="${pager.endPageNo}">
							<c:if test="${pager.pageNo !=i }">
								<a href="${pageContext.request.contextPath}/controller/qna/qnaBoardCategoryController?pageNo=${i}&category=${categoryNo}" class="btn btn-outline-success btn-sm" style="background-color:#ffffff; color:black">${i}</a>
							</c:if>
							
							<c:if test="${pager.pageNo ==i }">
								<a href="${pageContext.request.contextPath}/controller/qna/qnaBoardCategoryController?pageNo=${i}&category=${categoryNo}" class="btn btn-primary btn-sm" style="background-color: rgb(88, 39, 35);color:#ffffff;">${i}</a>
							</c:if>
						</c:forEach>
						
						<c:if test="${pager.groupNo< pager.totalGroupNo }">
							<a href="${pageContext.request.contextPath}/controller/qna/qnaBoardCategoryController?pageNo=${pager.endPageNo+1}&category=${categoryNo}" class="btn btn-outline-info btn-sm " style="background-color:#ffffff; color:black">다음</a>
						</c:if>
						<a href="${pageContext.request.contextPath}/controller/qna/qnaBoardCategoryController?pageNo=${pager.totalPageNo}&category=${categoryNo}" class="btn btn-outline-primary btn-sm" style="background-color:#ffffff; color:black">맨끝</a>
					</div>
				</div>
