      ...
      <!-- 전체 레이아웃 -->
       <div id = "header" class="container-fluid">
		...
		<div class = "row justify-content-center align-items-center">
			<div class = "col-sm-3"><a href = "${pageContext.request.contextPath}/controller/book/bookMainController?searchType=1&categoryNo=1&subCategoryNo=1&pageNo=1"><img src = "${pageContext.request.contextPath}/resources/images/imageOfBook/mainLogo.png" class = "w-75 h-75"/></a></div>
			<div class = "col-sm-5">	</div>
			<div class = "col-sm-2"></div>
			<div class = "col-sm-1 pr-0"><a href = "/shopping/controller/user/cartDetailController"><img src = "/shopping/resources/images/imageOfBook/장바구니.png" class = "rounded w-50 h-50"/></a></div>
			<div class = "col-sm-1 pl-0"><a href = "/shopping/controller/user/myPageMainController"><img src = "/shopping/resources/images/imageOfBook/마이페이지.png" class = "rounded w-50 h-50"/></a></div>
		</div>
               ...
               <div id="sideMenu" class="col-3">
                  <div class="mt-5">
                     <ul class="list-group">
                        ...
                        <li class="text-center list-group-item list-group-item-action"><a href = "/shopping/controller/user/myQnaBoardController?user_id=${user.user_id}" class="btn">문의 목록</a></li>
                   ...
                   <div class="card-body -0">
                      <table class="table">
                         <tbody>
                           ...
                           <tr>
                             <td>이름</td>
	                             <td class="td_middle">${user.user_name}</td>
                           </tr>
                           <tr>
                             <td>이메일</td>
                           	 <td class="td_middle">${user.user_email}</td>
                           ...
                           <tr>
                             <td>전화번호</td>
                             	<td class="td_middle">${user.user_tel}</td>
                           <td> </td>
                           </tr>
                           <tr>
                             <td>가입정보</td>
                  ...
                  <div class="card-body">
                     <table class="table">
                        <tbody>
                           <tr>
                              <td>주소</td>
                             <td class="td_middle">${user.user_address}</td>
                         </tr>                     
                           <tr>
                              <td>보유 금액</td>
