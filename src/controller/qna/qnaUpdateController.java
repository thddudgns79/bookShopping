...
@WebServlet(name = "controller.qna.qnaUpdateController", urlPatterns =  "/controller/qna/qnaUpdateController")
public class qnaUpdateController extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/qna/qnaUpdate.jsp").forward(request, response);
	}
